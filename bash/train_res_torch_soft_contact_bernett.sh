...
NEGATIVE_CENTER_LOSS_WEIGHT=${NEGATIVE_CENTER_LOSS_WEIGHT:-0.3}
NEGATIVE_CENTER_LOSS_MIN_COUNT=${NEGATIVE_CENTER_LOSS_MIN_COUNT:-2}
MIXUP_WEIGHT=${MIXUP_WEIGHT:-0.5}
MIXUP_LAM_MIN=${MIXUP_LAM_MIN:-0.35}
MIXUP_LAM_MAX=${MIXUP_LAM_MAX:-0.75}
SOFT_TARGET_LAMBDA=${SOFT_TARGET_LAMBDA:-0.7}
SOFT_TARGET_EMA_DECAY=${SOFT_TARGET_EMA_DECAY:-0.999}
SOFT_TARGET_POSITIVE_ONLY=${SOFT_TARGET_POSITIVE_ONLY:-0}
